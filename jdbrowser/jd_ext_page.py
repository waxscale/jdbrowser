...
class JdExtPage(QtWidgets.QWidget):
    ...
    def _setup_ui(self):
        if not hasattr(self, "scroll_area"):
            ...
            self.breadcrumb_bar = self._build_breadcrumb(
                [("Home", self.ascend_to_area), (crumb_area, self.ascend_level), (crumb_id, None)]
            )
    ...
    def _setup_shortcuts(self):
        ...
        self.normal_shortcuts = [
            ...
            (QtCore.Qt.Key_U, self.moveVertMultiple, -11, QtCore.Qt.KeyboardModifier.ControlModifier),
            (QtCore.Qt.Key_D, self.moveVertMultiple, 11, QtCore.Qt.KeyboardModifier.ControlModifier),
            (QtCore.Qt.Key_PageUp, self.moveVertMultiple, -11),
            (QtCore.Qt.Key_PageDown, self.moveVertMultiple, 11),
        ...
        # History and descend-only shortcuts
